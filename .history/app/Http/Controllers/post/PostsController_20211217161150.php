...
class PostsController extends Controller
{
    ...
    //いいね処理
    public function bookmark(Request $request) :int
    {
        ...
        if($flug===false)
        {
            return $this->updatePostPoint($request->id,$count);
        }
        else {
            return $count;
        }
