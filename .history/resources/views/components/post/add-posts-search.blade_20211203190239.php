<form action="{{ route('posts') }}" method="post" enctype="multipart/form-data">
    @csrf
    <div class="mt-2 w-full flex flex-wrap flex-row justify-between lg:justify-between text-gray-500 searchPostFx">
        <div class="w-6/12 lg:w-1/12 searchPostCnt" >
            <x-post.add-post-form-genre name="term" data=""></x-post.add-post-form-genre>
        </div>
        <div class="w-6/12 lg:w-1/12 lg:ml-2 searchPostCnt">
