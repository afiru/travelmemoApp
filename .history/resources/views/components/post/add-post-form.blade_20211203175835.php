<div class="mt-5 md:mt-0 md:col-span-2">
    <div class="px-4 py-5 bg-white sm:p-6 shadow rounded-md">
        ...
        <div class="grid grid-cols- gap-6 mt-8">
            ...
            <div class="flex justify-between items-center w-full lg:w-4/12 ">
                <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300 w-10/12"  type="number" step="0.01" name="cost" placeholder="※4名合計の金額" value="{{ old('url') }}" required="required">
