<form action="{{ route('posts') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="mt-2 w-full">
        <button type="submit" class="w-full justify-center　text-lg inline-flex items-center px-4 py-4 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition">
            検索する
        </button>
    </div>
</form>
