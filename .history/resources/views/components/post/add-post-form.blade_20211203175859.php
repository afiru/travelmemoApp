    ...
    <div class="px-4 py-5 bg-white sm:p-6 shadow rounded-md">
        ...
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4 w-full">
                ...
                <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300  w-full lg:w-4/12"  type="time" name="arrivalTime" placeholder="" step="900" required="required" min="10:00" max="18:00">
            </div>
        </div>
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="flex justify-between items-center w-full lg:w-4/12 ">
                    <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300 w-10/12"  type="number" step="0.25"name="stayTime" placeholder="1.5" value="{{ old('prefectures') }}" required="required">
