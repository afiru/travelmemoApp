<form action="{{ route('posts') }}" method="get">
    ...
    <div class="text-sm　mt-2 w-full flex flex-wrap flex-row justify-between lg:justify-start text-gray-500">
        <div class="w-6/12 lg:w-2/12">
            <x-post.add-post-form-genre name="where[term]" data="" genre="{{ $where['term'] }}"></x-post.add-post-form-genre>
        </div>
        <div class="w-6/12 lg:w-2/12">
            <x-post.add-post-form-genre name="where[subterm]" data="" genre="{{ $where['subterm'] }}"></x-post.add-post-form-genre>
        </div>
        <div class="w-6/12 lg:w-2/12">
