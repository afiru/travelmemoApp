<form action="{{ route('posts') }}" method="get">
    ...
    <div class="text-sm　mt-2 w-full flex flex-wrap flex-row justify-between lg:justify-start text-gray-500">
        ...
        <div class="w-6/12 lg:w-2/12">
            <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300  w-full" type="text" name="where[interchange]" placeholder="インターチェンジ名" @if(isset($where['prefectures'])) value="{{ $where['prefectures'] }}" @endif>
        </div>
        <div class="w-6/12 lg:w-2/12">
