    ...
    <div class="px-4 py-5 bg-white sm:p-6 shadow rounded-md">
        <div class="grid grid-cols- gap-6 mt-0">
            <div class="col-span-6 sm:col-span-4">
                ...
                <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300  w-full lg:w-4/12"  type="date" name="travelDate" placeholder="" list="date-list" required="required" min="2022-02-26" max="2022-02-27" @if(isset($datas)) @else value="{{ old('travelDate') }}" @endif>
        ...
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4 w-full">
                ...
                <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300  w-full lg:w-4/12"  type="time" name="arrivalTime" placeholder="" step="900" required="required" min="10:00" max="18:00" value="{{ old('arrivalTime') }}">
            </div>
        </div>
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4">
                ...
                <div class="flex justify-between items-center w-full lg:w-4/12 ">
                    <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300 w-10/12"  type="number" step="0.25"name="stayTime" placeholder="1.5" value="{{ old('stayTime') }}" required="required">
        ...
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4 w-full">
                ...
                <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300  w-full lg:w-4/12" type="text" name="prefectures" placeholder="" value="{{ old('prefectures') }}" required="required">
            </div>
        </div>
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4 w-full">
        ...
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4 w-full">
                ...
                <div class="w-2/12  lg:w-4/12"><x-post.add-post-form-genre name="subTerm" data=""></x-post.add-post-form-genre></div>
            </div>
        </div>
        <div class="grid grid-cols- gap-6 mt-8">
            <div class="col-span-6 sm:col-span-4 w-full">
