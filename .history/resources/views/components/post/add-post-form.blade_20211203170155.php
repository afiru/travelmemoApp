    ...
    <div class="px-4 py-5 bg-white sm:p-6 shadow rounded-md">
        <div class="grid grid-cols- gap-6 mt-0">
            <div class="col-span-6 sm:col-span-4">
                ...
                <input class="mt-2 py-2 px-2 rounded-md shadow border-gray-300  w-full lg:w-4/12"  type="date" name="travelDate" placeholder="" list="date-list" required="required" max="2022-02-27">
