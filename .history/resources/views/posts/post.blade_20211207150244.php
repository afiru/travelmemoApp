                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <table class="mt-4 w-full">
                                <tr>
                                    ...
                                    <th class="border border-solid border-gray-500">日付</th>
                                    <th class="border border-solid border-gray-500">到着時間</th>
                                    <th class="border border-solid border-gray-500">県名</th>
                                    <th class="border border-solid border-gray-500">最寄りIC名</th>
                                    <th class="border border-solid border-gray-500">場所名</th>
                                    <th class="border border-solid border-gray-500">ジャンル名</th>
                                    <th class="border border-solid border-gray-500">子ジャンル名</th>
                                    <th class="border border-solid border-gray-500">滞在時間</th>
                                    <th class="border border-solid border-gray-500">費用</th>
                                    <th class="border border-solid border-gray-500">ポイント</th>
                                    <th class="border border-solid border-gray-500">いいね</th>
                                </tr>
                                @foreach($data as $val)
                                <tr>
                                    <td class="py-2">
