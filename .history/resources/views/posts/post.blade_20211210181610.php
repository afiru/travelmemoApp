                ...
                <div class="bg-gray-200 bg-opacity-25 w-full">
                    <section class="p-6 sm:px-8  w-full border-b border-gray-200">
                        ...
                        <form action="{{ route('posts') }}" method="post">
                            ...
                            @foreach($data as $val)
                                <div class="buttonPost flex justify-between items-center mt-4 p-2 bg-white shadow-xl sm:rounded-lg">
                                    <input class="shadow-xl inputCheck" type="checkbox" name="post_id[]" value="{{ $val['id'] }}">
                                    <section class="w-10/12">
                                        ...
                                        <div class="w-full flex justify-end item-center">
                                            <div class="flex items-center justify-end">
                                                ...
                                                <span
                                                class="ml-4 cursor-pointer block mt-1 mb-1 px-2 p-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 transition jsButtonPost buttonPost"
                                                data-id="{{ $val['id'] }}"
