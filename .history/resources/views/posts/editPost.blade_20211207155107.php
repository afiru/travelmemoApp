...
<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="/post/{{ $datas->id }}" method="post" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="postid" value="{{ $datas->id }}">
                <section class="md:grid md:grid-cols-3 md:gap-6 PostAdd">
                    ...
                    <x-post.add-post-form :data=$datas></x-post.add-post-form>
                </section>
            </form>
        </div>
    </div>
