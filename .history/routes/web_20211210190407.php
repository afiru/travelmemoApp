...
Route::get('/topics', 'App\Http\Controllers\HelloController@index')->name('topics')->middleware('auth');
Route::get('/addtopics', 'App\Http\Controllers\HelloController@index')->name('addtopics')->middleware('auth');
