...
Route::get('/topics/{topicid}', [AddTopicsController::class, 'index'])->name('topics')->middleware('auth');
//編集
...
//削除
Route::post('/deltopics', [AddTopicsController::class, 'deltopics'])->middleware('auth');
