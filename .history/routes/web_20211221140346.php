...
//編集
Route::get('/editotopic/{postid}', [AddTopicsController::class, 'editotopic'])->name('editpost')->middleware('auth');
Route::post('/editotopic/{postid}', [AddTopicsController::class, 'updatePost'])->name('editpost')->middleware('auth');
