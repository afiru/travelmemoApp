...
Route::post('/topics', 'App\Http\Controllers\HelloController@index')->middleware('auth');
Route::post('/addtopics', 'App\Http\Controllers\HelloController@index')->middleware('auth');
