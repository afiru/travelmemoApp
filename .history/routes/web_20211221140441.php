...
//編集
Route::get('/editotopic/{topicid}', [AddTopicsController::class, 'editotopic'])->name('editpost')->middleware('auth');
Route::post('/editotopic/{topicid}', [AddTopicsController::class, 'updatePost'])->name('editpost')->middleware('auth');
