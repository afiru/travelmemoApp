...
Route::post('/topics', 'App\Http\Controllers\HelloController@index')->name('topics')->middleware('auth');
Route::post('/addtopics', 'App\Http\Controllers\HelloController@index')->name('addtopics')->middleware('auth');
