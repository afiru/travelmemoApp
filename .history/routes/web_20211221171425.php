...
Route::get('/editoinvoice/{invoiceid}', [invoicesController::class, 'addinvoices'])->name('addinvoice')->middleware('auth');
Route::post('/editoinvoice/{invoiceid}', [invoicesController::class, 'add'])->name('addinvoice')->middleware('auth');
